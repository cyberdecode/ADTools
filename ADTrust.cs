...
namespace ADTrust
{
    public class Program
    {
        ...
        {
            // handle SID
            if ( (key.Contains("sid")) || (key.Contains("securityidentifier")) )
            {
        ...
        public static void GetTrustInfo ( string namingContext, string trustName )
        {
                    ...
                    ))
            {
                ...
                switch ( trustName )
                {
                    ...
                    default:
                        LDAPFilter = string.Format ( "(&(objectClass=trustedDomain)(name={0}))", trustName );
                        break;
                }
                ...
                if ( trustName == "all" )
                {
                    ...
                    ds.PropertiesToLoad.Add("flatname");
                    ds.PropertiesToLoad.Add("securityidentifier");
                    ds.PropertiesToLoad.Add("trustdirection");
                }
                ...
                using ( SearchResultCollection src = ds.FindAll() )
                {
                    ...
                    else {  Console.WriteLine ( string.Format ( "\n[!!] No Trust found for {0} - {1}\n", namingContext, trustName ) ); }
                }
            }
        }    
        ...
        public static void Main (string[] args)
        {
            ...
            {
                Console.WriteLine ( string.Format ( "\n[*] Usage: ADTrust.exe [namingContext] [trustName | all]" ));
                System.Environment.Exit(0);
            }

            // get user information / data 
            GetTrustInfo ( args[0].ToString(), args[1].ToString() );
        }
    }
}