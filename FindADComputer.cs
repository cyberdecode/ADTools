...
namespace FindADComputer
{
    class Program
    {
        ...
        public static void GetComputerInfo ( string namingContext, string computername )
        {
            ...
            {
                string LDAPFilter = string.Format ( "(&(objectClass=computer)(sAMAccountName={0}$))", computername );
        ...
        public static void Main ( string[] args )
        {
            ...
            {
                Console.WriteLine ( string.Format ( "\n[*] Usage: FindADComputer [namingContext] [samaccountname]" ));
