...
namespace ADSubnets
{
    class Program
    {
        ...
        public static void GetSubnetInfo ( string namingContext, string subnetName )
        {
                    ...
                    ))
            {
                ...
                switch ( subnetName )
                {
                    ...
                    default:
                        LDAPFilter = string.Format ( "(&(objectClass=subnet)(name={0}))", subnetName );
                        break;
                }
                ...
                using ( SearchResultCollection src = ds.FindAll() )
                {
                    ...
                    else {  Console.WriteLine ( string.Format ( "\n[!!] No Subnet found for {0} - {1}.\n", namingContext, subnetName  ) ); }
                }
            }
        }    
        ...
        public static void Main ( string[] args )
        {
            ...
            {
                Console.WriteLine ( string.Format ( "\n[*] Usage: ADSubnets.exe [rootDomainNamingContext] [subnetName | all]" ));
                System.Environment.Exit(0);
            }

            GetSubnetInfo ( args[0].ToString(), args[1].ToString() );
        }
    }
}