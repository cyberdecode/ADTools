...
namespace FindADSID
{
    class Program
    {
        ...
        public static void GetADSID ( string namingContext, string sid )
        {
            ...
            {
                string LDAPFilter = string.Format ( "(objectsid={0})", sid );
        ...
        public static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine ( string.Format ( "\n[*] Usage: FindADSID [namingContext] [SID]" ));
                System.Environment.Exit(0);
            }

            GetADSID( args[0].ToString() , args[1].ToString() );
