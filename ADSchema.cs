...
namespace ADSchema
{
    class Program
    {
        ...
        public static void GetSchemaInfo ( string schemaNamingContext, string ldapFilter )
        {
            using ( DirectoryEntry de = new DirectoryEntry (
                        string.Format ( "LDAP://{0}", schemaNamingContext ),
                        null,
                        null,
                    ...
                    ))
                    {
                        ...
                        using ( SearchResultCollection src = ds.FindAll() )
                        {
                            ...
                            else {  Console.WriteLine ( string.Format ( "\n[!!] No Schema object found for {0}, {1}\n", schemaNamingContext, ldapFilter ) ); }
        ...
        public static void Main ( string[] args )
        {
            ...
            {
                Console.WriteLine ( string.Format ( "\n[*] Usage: ADSchema [schemaNamingContext] [ldapfilter]" ));
                System.Environment.Exit(0);
            }

            // get user information / data 
            GetSchemaInfo ( args[0].ToString(), args[1].ToString() );
        }
    }
}