...
namespace ADGroup
{
    class Program
    {
        ...
        public static void GetGroupInfo ( string namingContext, string groupname )
        {
                    ...
                    ))
            {
                ...
                {
                    LDAPFilter = string.Format ( "(&(objectClass=group)(sAMAccountName={0}))", groupname );
                }
        ...
        public static void Main ( string[] args )
        {
            ...
            {
                Console.WriteLine ( string.Format ( "\n[*] Usage: ADGroup.exe [namingContext] [samaccountname | all]" ));
                System.Environment.Exit(0);
            }

            // get user information / data 
            GetGroupInfo ( args[0].ToString(), args[1].ToString() );
        }
    }
}