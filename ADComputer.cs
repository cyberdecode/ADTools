...
namespace ADComputer
{
    class Program
    {
        ...
        public static void GetComputerInfo ( string namingContext, string computername )
        {
                    ...
                    ))
            {
                ...
                if ( computername == "all" )
                { 
                    LDAPFilter = "(&(objectClass=computer)(samAccountType=805306369))";
                }
                else
                {
                    LDAPFilter = string.Format( "(&(objectClass=computer)(samAccountType=805306369)(sAMAccountName={0}$))", computername );
                }
                ...
                // handle attributes for all parameter
                if ( computername == "all" )
                {
        ...
        public static void Main ( string[] args )
        {
            ...
            {
                Console.WriteLine ( string.Format ( "\n[*] Usage: ADComputer.exe [namingContext] [samaccountname | all]" ));
                System.Environment.Exit(0);
            }

            // get user information / data 
            GetComputerInfo ( args[0].ToString(), args[1].ToString() );
        }
    }
}