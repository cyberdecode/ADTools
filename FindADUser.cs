    ...
    class Program
    {
        ...
        public static void GetUserInfo ( string namingContext, string username )
        {
            using ( DirectoryEntry de = new DirectoryEntry (
                    ...
                    {
                        string LDAPFilter = string.Format ( "(&(objectClass=user)(sAMAccountType=805306368)(sAMAccountName={0}))", username );
        ...
        public static void Main ( string[] args )
        {
            ...
            {
                Console.WriteLine ( string.Format ( "\n[*] Usage: FindADUser [namingContext] [samaccountname]" ));
