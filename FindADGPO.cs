...
namespace FindADGPO
{
    class Program
    {
        ...
        public static void GetGPOInfo ( string namingContext, string gpo )
        {
                    ...
                    ))
            {
                ...
                switch (gpo)
                {
                    ...
                    default:
                        LDAPFilter = string.Format ( "(&(objectClass=grouppolicycontainer)(cn={0}))", "{" + gpo + "}" );
                        break;
                }
        ...
        public static void Main ( string[] args )
        {
            ...
            {
                Console.WriteLine ( string.Format ( "\n[*] Usage: FindADGPO [namingContext] [cn|all]" ));
